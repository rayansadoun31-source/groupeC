...
CERES_FILE_PATH = (
    pathlib.Path("modele_Tsol_principal/modele_principal/codes python/ressources/albedo")
...
# ────────────────────────────────────────────────
SHAPEFILE_PATH = (
    pathlib.Path("modele_Tsol_principal/modele_principal/codes python/ressources/map") / "ne_110m_admin_0_countries.shp"
)
