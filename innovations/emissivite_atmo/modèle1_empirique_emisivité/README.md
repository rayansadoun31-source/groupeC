...
* **[`Documentation_emissivite_code_1.pdf`](Documentation_emissivite_code_1.pdf)** | *Contenu :* Rapport technique explicitant la démarche physique et le fonctionnement du premier modèle à une seule couche.
