...
* **['code_sciences_etonnantes_co2_traverse_atmosphere.py'](code_sciences_etonnantes_co2_traverse_atmosphere.py)** | *Application :* Script implémentant une simulation vectorisée du transfert radiatif à travers différents modèles d'atmosphère, afin de calculer et de tracer l'impact du doublement de la concentration en CO2​ sur le spectre du flux infrarouge sortant de la Terre.
