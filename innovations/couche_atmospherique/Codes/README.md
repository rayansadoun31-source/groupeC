...
### 1. [Modèle à 1 couche (`atmosphere_1_couche_tropausphere_8km.py`)](./atmosphere_1_couche_troposphere_8km.py)
...
### 2. [Modèle à 2 couches (`atmosphere_2_couche_tropausphere_8km.py`)](./atmosphere_2_couche_troposphere_8km.py)
