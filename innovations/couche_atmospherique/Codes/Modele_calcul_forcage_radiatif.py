...
# 11. SAUVEGARDE
# =============================================================================
nom_fichier_bilan = f'Bilan_Radiatif_Net_Global_{SUFFIXE_FICHIER}.npy'
nom_fichier_forcage = f'Forcage_Atmospherique_{SUFFIXE_FICHIER}.npy'

np.save(nom_fichier_bilan, Bilan_Radiatif_Net_3D)
np.save(nom_fichier_forcage, Forcage_Atmospherique_3D)

print(f"\nCalculs terminés. Fichiers générés avec succès :")
