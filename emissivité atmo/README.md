...
### 1. [Modèle Empirique d'Émissivité](./modèle1_empirique_emisivité/)
...
### 2. [Modèle d'Émissivité Haute Précision - HITRAN](./modèle2_hitran_emissivité/)
...
### 3. [Comparaison des Modèles de Sections Efficaces](./comparaison_modeles_sections_efficaces/)
